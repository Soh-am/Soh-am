...
export function AIHelpAssistant({ currentRole, onBack }: AIHelpAssistantProps) {
    ...
    return (
      ...
      >
        <Button
          ...
          className="rounded-full w-14 h-14 bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 shadow-lg border-2 border-blue-400/30"
        >
        ...
        <motion.div
          ...
          className="absolute bottom-16 right-0 bg-blue-600 text-white px-3 py-1 rounded-lg text-sm whitespace-nowrap"
        >
          AI Assistant
          ...
          {!isMinimized && (
            ...
            >
              ...
              <div className="p-4 border-b border-blue-200/30">
                ...
                <h4 className="font-semibold text-foreground mb-1">{helpContent.title}</h4>
                ...
                <div className="space-y-2">
                  ...
                  {helpContent.quickActions.slice(0, 2).map((action, index) => (
                    <button
                      ...
                      className="w-full flex items-center gap-2 p-2 rounded-md bg-blue-50/50 hover:bg-blue-100/50 transition-colors text-left"
                    >
                      {action.icon}
